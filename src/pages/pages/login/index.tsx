...
const LoginPage = () => {
  ...
  useEffect(() => {
    if (AuthService.getCurrentUser()) router.push('/bilirkisi-rapor')
  }, [router])
        ...
        <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
          ...
          <Box sx={{ mb: 6 }}>
            <Typography variant='h5' sx={{ fontWeight: 600, marginBottom: 1.5 }}>
              {themeConfig.templateName}'e hoşgeldin! 👋🏻
            </Typography>
            <Typography variant='body2'>Lütfen giriş yapmak için bilgilerinizi girin</Typography>
          </Box>
            ...
            >
              ...
              <Typography variant='body2'>
                <Link passHref href='/pages/register'>
                  <LinkStyled>Bir hesap oluştur</LinkStyled>
                </Link>
              </Typography>
            </Box>
